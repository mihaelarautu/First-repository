...
- Provides everything to display heavily nested object structures.
...
- Therefore, to enforce such constraint, the program must rely on run-time checks,
since it cannot use the type system the of programming language.
'''
